            ...
            <div className='home-tool'>
                <Paper elevation={3} className={classes.paper}>
                    ...
                    <FormControl className={classes.cinema}>
                        ...
                        {props.cinemas.length > 0 ? (
                            ...
                            <Select
                                ...
                                value=''
                            >
                                <MenuItem value='Vui lòng chọn phim.'>
                                    Vui lòng chọn phim.
                                </MenuItem>
                            </Select>
                        )}
                    ...
                    <FormControl className={classes.date}>
                        <InputLabel id='date-select-label'>Ngày xem</InputLabel>
                        {quickTicket.dates.length > 0 ? (
                            ...
                            <Select
                                ...
                                value=''
                            >
                                <MenuItem value='Vui lòng chọn phim và rạp.'>
                    ...
                    <FormControl className={classes.showtime}>
                        ...
                        {quickTicket.showtimes.length > 0 ? (
                            ...
                            <Select
                                ...
                                value=''
                            >
                                <MenuItem value='Vui lòng chọn phim, rạp và ngày chiếu'>
